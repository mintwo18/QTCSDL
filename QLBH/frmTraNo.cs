...
namespace QLBH
{
    public partial class frmTraNo : Form
    {
        ...
        private void LoadData()
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    dataGridView_TraNo.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
                }
            }
            catch (Exception ex)
            {
        ...
        {
            string tuKhoa = textBox_MaNCC.Text.Trim();
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    string query = @"
                        SELECT MANCC, TONGTIEN_TRA, NGAYTRA, TRANGTHAI_TRA
                        FROM TRANO
        ...
        {
            textBox_MaNCC.Text = "";
            textBox_TongTienTra.Text = "";
            dateTimePicker_NgayTra.Value = DateTime.Now;
            checkBox_DaTraHet.Checked = false;
            checkBox_TraMotPhan.Checked = false;
            checkBox_ChuaTra.Checked = false;
            textBox_MaNCC.ReadOnly = false;
            selectedRowIndex = -1;
        }
