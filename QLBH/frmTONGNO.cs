...
namespace NhapHang
{
    public partial class frmTONGNO : Form
    {
        ...
        private void LoadData()
        {
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    dataGridViewTONGNO.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.AllCells;
                }
                catch (Exception ex)
                {
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            txtTONGNO.Text = string.Format("{0:N0} VND", tongNo);
            txtNOCU.Text = string.Format("{0:N0} VND", noCu);
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (index >= 0)
            {
                ...
                decimal tongNo = 0;
                if (decimal.TryParse(dataGridViewTONGNO.CurrentRow.Cells["TONGNO"].Value.ToString(), out tongNo))
                {
                    txtTONGNO.Text = tongNo.ToString("N0", new System.Globalization.CultureInfo("vi-VN")) + " VND";
                }
                decimal noCu = 0;
                if (decimal.TryParse(dataGridViewTONGNO.CurrentRow.Cells["NOCU"].Value.ToString(), out noCu))
                {
                    txtNOCU.Text = noCu.ToString("N0", new System.Globalization.CultureInfo("vi-VN")) + " VND";
                }
            }
        }
    }
