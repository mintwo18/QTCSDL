...
namespace WindowsFormsAppQLBH_LOHANG
{
    public partial class FormLOHANG : Form
    {
        ...
        public FormLOHANG()
        {
            ...
            btn_ThongBao.Click += (s, e) => sp_HSD_LOHANG();
        ...
        private void LoadData()
        {
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                ...
                DataGridView_LOHANG.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
            }
        }
        ...
        private void sp_HSD_LOHANG()
        {
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                SqlCommand cmd = new SqlCommand("sp_HSD_LOHANG", conn);
        ...
        private void DataGridView_LOHANG_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
